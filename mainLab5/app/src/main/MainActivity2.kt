...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dato : datos = intent.getSerializableExtra("DatoExtra") as datos
    ...
    private fun checkCameraPermission(){
        if(!hasCameraPermission()) {
            ...
            Toast.makeText(applicationContext, "Permiso para abrir Camára", Toast.LENGTH_LONG).show()
